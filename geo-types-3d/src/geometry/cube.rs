// use crate::{coordZ, polygon, CoordFloat, CoordNum, CoordZ, Line, Polygon};
...
//     /// ```
//     pub fn new<C>(c1: C, c2: C, c3: C) -> Self
//     where
//         C: Into<CoordZ<T>>,
//     {
//         let c1 = c1.into();
...
//         };
//         Self {
//             min: coordZ! { x: min_x, y: min_y, z: },
//             max: coordZ! { x: max_x, y: max_y },
//         }
//     }
...
//     )]
//     #[allow(deprecated)]
//     pub fn try_new<C>(c1: C, c2: C) -> Result<Cube<T>, InvalidRectCoordinatesError>
//     where
//         C: Into<CoordZ<T>>,
//     {
//         Ok(Cube::new(c1, c2))
...
//     /// );
//     /// ```
//     pub fn split_x(self) -> [Cube<T>; 2] {
//         let two = T::one() + T::one();
//         let mid_x = self.min().x + self.width() / two;
//         [
//             Cube::new(self.min(), coordZ! { x: mid_x, y: self.max().y }),
//             Cube::new(coordZ! { x: mid_x, y: self.min().y }, self.max()),
//         ]
//     }
...
//     /// );
//     /// ```
//     pub fn split_y(self) -> [Cube<T>; 2] {
//         let two = T::one() + T::one();
//         let mid_y = self.min().y + self.height() / two;
//         [
//             Cube::new(self.min(), coordZ! { x: self.max().x, y: mid_y }),
//             Cube::new(coordZ! { x: self.min().x, y: mid_y }, self.max()),
//         ]
//     }
...
// mod test {
//     use super::*;
//     use crate::{coord, coordZ};

//     #[test]
//     fn rect() {
//         let rect = Cube::new((10, 10), (20, 20));
//         assert_eq!(rect.min, coordZ! { x: 10, y: 10, z: 10 });
//         assert_eq!(rect.max, coordZ! { x: 20, y: 20, z: 20 });

//         let rect = Cube::new((20, 20, ), (10, 10));
//         assert_eq!(rect.min, coordZ! { x: 10, y: 10, z: 10 });
//         assert_eq!(rect.max, coordZ! { x: 20, y: 20, z: 20 });

//         let rect = Cube::new((10, 20), (20, 10));
//         assert_eq!(rect.min, coordZ! { x: 10, y: 10 });
//         assert_eq!(rect.max, coordZ! { x: 20, y: 20 });
//     }
...
//     fn rect_center() {
//         assert_relative_eq!(
//             Cube::new((0., 10.), (10., 90.)).center(),
//             CoordZ::from((5., 50.))
//         );
//         assert_relative_eq!(
//             Cube::new((-42., -42.), (42., 42.)).center(),
//             CoordZ::from((0., 0.))
//         );
//         assert_relative_eq!(
//             Cube::new((0., 0.), (0., 0.)).center(),
//             CoordZ::from((0., 0.))
//         );
//     }
// }
